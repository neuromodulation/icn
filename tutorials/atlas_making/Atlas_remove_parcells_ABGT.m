...
areas = readtable('Atlas of the Basal Ganglia and Thalamus (He 2020) - 2mm MNI152.txt');

%% Find the indices of the regions we want to exclude
indices = areas.Var1(ci({'GPe','GPi','SN','Thalamus','Tha'},areas.Var2));
...
nii = ea_load_nii('C:\Users\Jonathan\Documents\DATA\ATLAS_creation\Atlas of the Basal Ganglia and Thalamus (He 2020) - 2mm MNI152.nii');
...
nii.fname = 'ABGT (He 2020) - 2mm MNI152_only striatum_renumbered.nii';


%% Write the nii variable to a nifti file
ea_write_nii(nii);
writetable(areas,'ABGT (He 2020) - 2mm MNI152_only striatum_renumbered.txt','Delimiter',' ')
