...
if VICTORIA is True:
    ...
    settings['out_path'] = "C:\\Users\\ICN_admin\\Dropbox (Brain Modulation Lab)\\Shared Lab Folders\\CRCNS\\MOVEMENT DATA\\derivatives\\Int_dist_15_Median_10\\"



settings['resamplingrate']=10
settings['max_dist_cortex']=15
settings['max_dist_subcortex']=15
