...
addpath(fullfile('C:\Users\Jonathan\Documents\MATLAB\add_on_Matlab\trinkets'));
ft_defaults
intern_cfg = [];
cfg = [];
...
[~,intern_cfg] = retrieve_BIDS_settings(cfg, intern_cfg);
...
[cfg,intern_cfg] = retrieve_BIDS_settings(cfg, intern_cfg);
if draw_figures
    figure
    wjn_plot_raw_signals(intern_cfg.data.time{1},intern_cfg.data.trial{1},intern_cfg.data.label);
end
