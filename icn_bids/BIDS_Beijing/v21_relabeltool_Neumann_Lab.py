...
path_target_folder=r"C:\Users\Jonathan\Charité - Universitätsmedizin Berlin\Interventional Cognitive Neuromodulation - Data\BIDS_Beijing_ECOG_LFP\conversion_room\final"
#path_target_folder=r"C:\Users\Jonathan\Documents\DATA\PROJECT_Tiantan\conversion_room\electrodes"
back_up_folder=r"C:\Users\Jonathan\Documents\DATA\PROJECT_Tiantan\conversion_room"
...
if go1:
    ...
    for i in range(len(target_expression_list)):
        ...
        for n in range(0,len(list_of_paths_files)):
            ...
            if os.stat(path_current_file).st_size >= 1048576:  # and not 1000000 as 1024 * 1024
                print("Excluded from reading content: size is more than 10MB in following file. " + current_file)
        ...
        if go2:
            ...
            for n in range(0, len(df_dirnames.index)):
                if not df_dirnames['path_subfolders_to_be_changed'][n]:
                    ...
                    os.rename(path_subfolder_to_be_changed,path_target_folder + os.sep + change_dirname_into)
