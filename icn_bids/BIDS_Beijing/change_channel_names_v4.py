...
for vhdr_path in vhdr_paths:
    ...
    # set all channel types to ECOG for iEEG - BIDS does not allow more than one channel type --- > it does!
    ...
    montage=mne.channels.make_dig_montage(coord_frame='mri')

    raw_arr.set_montage(montage=montage, on_missing='ignore')
